...
class AuthOAuth2Bridge {
    ...
    showFallbackSignInForm() {
        ...
        modal.innerHTML = `
            <div style="position: fixed; inset-block-start: 0; inset-inline-start: 0; inline-size: 100%; block-size: 100%; background: rgba(0,0,0,0.5); z-index: 10000; display: flex; align-items: center; justify-content: center;">
                <div style="background: white; padding: 30px; border-radius: 12px; max-inline-size: 400px; inline-size: 90%;">
                    <h3 style="margin-block-start: 0; color: #333;">🚀 Quick Sign Up</h3>
                    <p style="color: #666; margin-block-end: 20px;">While we set up Google OAuth, you can create an account manually:</p>
                    
                    <div style="margin-block-end: 15px;">
                        <label style="display: block; margin-block-end: 5px; font-weight: 500;">Name:</label>
                        <input id="fallback-name" type="text" placeholder="Enter your name" style="inline-size: 100%; padding: 10px; border: 2px solid #ddd; border-radius: 6px; font-size: 16px;">
                    </div>
                    
                    <div style="margin-block-end: 20px;">
                        <label style="display: block; margin-block-end: 5px; font-weight: 500;">Email:</label>
                        <input id="fallback-email" type="email" placeholder="Enter your email" style="inline-size: 100%; padding: 10px; border: 2px solid #ddd; border-radius: 6px; font-size: 16px;">
                    </div>
